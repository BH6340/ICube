import{$t as e,At as t,Bt as n,C as r,It as i,K as a,Rt as o,Ut as s,Vt as c,Wt as l,in as u,m as d,p as f,pn as p,t as m,tn as h,xn as g,zt as _}from"./_plugin-vue_export-helper-XCSx_nk5.js";import{M as v}from"./index-LT-Qmtlu.js";import"./css-BygkPzZD.js";var y={class:`tutorial-container`},b={class:`tutorial-header`},x={class:`tutorial-body`},S={class:`steps-sidebar`},C={class:`steps-content`},w={class:`step-header`},T={class:`step-target`},E={key:0,class:`target-image`},D={key:1,class:`target-image placeholder`},O={class:`step-content`},k=[`innerHTML`],A={key:0,class:`step-formula`},j={class:`formula-box`},M={key:1,class:`step-tips`},N={class:`step-nav`},P=m({__name:`BeginnerTutorial`,setup(m){let P=v(),F=p(0),I=[{title:`第一步：对好第一面十字`,subtitle:`建立白色底面十字`,targetImage:`https://aka.doubaocdn.com/s/tmLs1wo1lu`,targetDesc:`目标：白色底面十字，四个侧面的棱与中心块同色`,content:`
    ...
    `,formula:[[`F2`,`U`,`L`,`R'`,`F2`,`L'`,`R`,`U`,`F2`]],tips:[`先找已经归位的棱块`,`归位的面放在后面`,`做完公式后检查魔方是否完全还原`,`如果还没还原，再做一次公式`]}],L=()=>{F.value<I.length-1&&F.value++},R=()=>{F.value>0&&F.value--},z=()=>{P.push(`/tutorials`)};return(p,m)=>{let v=a,P=f,B=d,V=r;return e(),c(`div`,y,[o(`div`,b,[m[1]||=o(`h1`,null,`三阶魔方入门教程`,-1),m[2]||=o(`p`,{class:`subtitle`},`层先法 - 7步还原魔方`,-1),l(v,{onClick:z,icon:`el-icon-arrow-left`,plain:``,size:`small`},{default:u(()=>[...m[0]||=[s(`返回首页`,-1)]]),_:1})]),o(`div`,x,[o(`div`,S,[l(B,{active:F.value,"align-center":``,direction:`vertical`},{default:u(()=>[(e(),c(i,null,h(I,(e,t)=>l(P,{key:t,title:e.title},{description:u(()=>[o(`span`,null,g(e.subtitle),1)]),_:2},1032,[`title`])),64))]),_:1},8,[`active`])]),o(`div`,C,[l(t,{name:`fade`,mode:`out-in`},{default:u(()=>[(e(),c(`div`,{key:F.value,class:`step-detail`},[o(`div`,w,[o(`h2`,null,g(I[F.value].title),1),o(`p`,null,g(I[F.value].subtitle),1)]),o(`div`,T,[m[4]||=o(`h3`,null,`目标状态`,-1),I[F.value].targetImage?(e(),c(`div`,E,[l(V,{src:I[F.value].targetImage,fit:`cover`},null,8,[`src`])])):(e(),c(`div`,D,[...m[3]||=[o(`span`,{class:`placeholder-icon`},`🎲`,-1),o(`span`,{class:`placeholder-text`},`目标状态示意图`,-1)]])),o(`p`,null,g(I[F.value].targetDesc),1)]),o(`div`,O,[o(`div`,{innerHTML:I[F.value].content},null,8,k)]),I[F.value].formula&&I[F.value].formula.length>0?(e(),c(`div`,A,[m[5]||=o(`h3`,null,`核心公式`,-1),(e(!0),c(i,null,h(I[F.value].formula,(t,n)=>(e(),c(`div`,{key:n,class:`formula-group`},[o(`div`,j,[(e(!0),c(i,null,h(t,(t,n)=>(e(),c(`span`,{key:n,class:`formula-item`},g(t),1))),128))])]))),128))])):n(``,!0),I[F.value].tips?(e(),c(`div`,M,[m[6]||=o(`h3`,null,`小贴士`,-1),o(`ul`,null,[(e(!0),c(i,null,h(I[F.value].tips,(t,n)=>(e(),c(`li`,{key:n},g(t),1))),128))])])):n(``,!0)]))]),_:1}),o(`div`,N,[l(v,{onClick:R,disabled:F.value===0,icon:`el-icon-arrow-left`},{default:u(()=>[...m[7]||=[s(` 上一步 `,-1)]]),_:1},8,[`disabled`]),F.value<I.length-1?(e(),_(v,{key:0,onClick:L,type:`primary`,icon:`el-icon-arrow-right`},{default:u(()=>[...m[8]||=[s(` 下一步 `,-1)]]),_:1})):(e(),_(v,{key:1,onClick:z,type:`success`,icon:`el-icon-check`},{default:u(()=>[...m[9]||=[s(` 完成学习 `,-1)]]),_:1}))])])])])}}},[[`__scopeId`,`data-v-9c6ddd18`]]);export{P as default};