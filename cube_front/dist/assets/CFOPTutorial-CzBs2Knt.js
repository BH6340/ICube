import{Bt as e,Et as t,F as n,Ft as r,H as i,I as a,It as o,K as s,Lt as c,Mt as l,Pt as u,Yt as d,Zt as f,_n as p,en as m,ln as h,m as g,p as _,t as v,zt as y}from"./_plugin-vue_export-helper-JH9cbz86.js";import{D as b}from"./index-BCb4XpZg.js";import"./css-CYXSJ7pS.js";import"./css-B1_3_UB_.js";import"./css-BaUOJ3rO2.js";var ee={class:`tutorial-container`},te={class:`tutorial-header`},ne={class:`tutorial-body`},x={class:`steps-sidebar`},S={class:`steps-content`},C={class:`step-header`},w={class:`step-info`},T={class:`info-card`},E={class:`info-icon`},D={class:`info-text`},O={class:`info-card`},k={class:`info-text`},A={class:`info-card`},j={class:`info-text`},M={class:`info-card`},N={class:`info-text`},P={class:`step-content`},F=[`innerHTML`],re={key:0,class:`step-formula`},I={key:0,class:`formula-name`},L={class:`formula-box`},R={key:1,class:`step-tips`},z={key:2,class:`step-advanced`},B=[`innerHTML`],V={class:`step-nav`},H={class:`learning-path`},U=v({__name:`CFOPTutorial`,setup(v){let U=b(),W=h(0),G=[{title:`第一步：十字 (Cross)`,subtitle:`高效规划和执行底层十字`,icon:`🔲`,stats:{algoCount:`0个`,targetTime:`3-5秒`,difficulty:`简单`,goal:`8步以内完成`},content:`
