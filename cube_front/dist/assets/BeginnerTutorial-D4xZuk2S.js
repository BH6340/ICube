import{Bt as e,C as t,Et as n,Ft as r,It as i,K as a,Lt as o,Mt as s,Pt as c,Yt as l,Zt as u,_n as d,en as f,ln as p,m,p as h,t as g,zt as _}from"./_plugin-vue_export-helper-Dii884fZ.js";import{T as v}from"./index-B_2YJ478.js";import"./css-sAqSDmgS2.js";var y={class:`tutorial-container`},b={class:`tutorial-header`},x={class:`tutorial-body`},S={class:`steps-sidebar`},C={class:`steps-content`},w={class:`step-header`},T={class:`step-target`},E={key:0,class:`target-image`},D={key:1,class:`target-image placeholder`},O={class:`step-content`},k=[`innerHTML`],A={key:0,class:`step-formula`},j={class:`formula-box`},M={key:1,class:`step-tips`},N={class:`step-nav`},P=g({__name:`BeginnerTutorial`,setup(g){let P=v(),F=p(0),I=[{title:`第一步：对好第一面十字`,subtitle:`建立白色底面十字`,targetImage:`https://aka.doubaocdn.com/s/tmLs1wo1lu`,targetDesc:`目标：白色底面十字，四个侧面的棱与中心块同色`,content:`
