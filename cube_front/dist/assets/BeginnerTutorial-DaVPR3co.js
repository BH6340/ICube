import{Bt as e,C as t,Et as n,Ft as r,It as i,K as a,Lt as o,Mt as s,Pt as c,Yt as l,Zt as u,_n as d,en as f,ln as p,m,p as h,t as g,zt as _}from"./_plugin-vue_export-helper-JH9cbz86.js";import{D as v}from"./index-BCb4XpZg.js";import"./css-BaUOJ3rO2.js";var y={class:`tutorial-container`},b={class:`tutorial-header`},x={class:`tutorial-body`},S={class:`steps-sidebar`},C={class:`steps-content`},w={class:`step-header`},T={class:`step-target`},E={key:0,class:`target-image`},D={key:1,class:`target-image placeholder`},O={class:`step-content`},k=[`innerHTML`],A={key:0,class:`step-formula`},j={class:`formula-box`},M={key:1,class:`step-tips`},N={class:`step-nav`},P=g({__name:`BeginnerTutorial`,setup(g){let P=v(),F=p(0),I=[{title:`第一步：对好第一面十字`,subtitle:`建立白色底面十字`,targetImage:`https://aka.doubaocdn.com/s/tmLs1wo1lu`,targetDesc:`目标：白色底面十字，四个侧面的棱与中心块同色`,content:`
    ...
    `,formula:[[`F2`,`U`,`L`,`R'`,`F2`,`L'`,`R`,`U`,`F2`]],tips:[`先找已经归位的棱块`,`归位的面放在后面`,`做完公式后检查魔方是否完全还原`,`如果还没还原，再做一次公式`]}],L=()=>{F.value<I.length-1&&F.value++},R=()=>{F.value>0&&F.value--},z=()=>{P.push(`/tutorials`)};return(p,g)=>{let v=a,P=h,B=m,V=t;return l(),o(`div`,y,[c(`div`,b,[g[1]||=c(`h1`,null,`三阶魔方入门教程`,-1),g[2]||=c(`p`,{class:`subtitle`},`层先法 - 7步还原魔方`,-1),e(v,{onClick:z,icon:`el-icon-arrow-left`,plain:``,size:`small`},{default:f(()=>[...g[0]||=[_(`返回首页`,-1)]]),_:1})]),c(`div`,x,[c(`div`,S,[e(B,{active:F.value,"align-center":``,direction:`vertical`},{default:f(()=>[(l(),o(s,null,u(I,(t,n)=>e(P,{key:n,title:t.title},{description:f(()=>[c(`span`,null,d(t.subtitle),1)]),_:2},1032,[`title`])),64))]),_:1},8,[`active`])]),c(`div`,C,[e(n,{name:`fade`,mode:`out-in`},{default:f(()=>[(l(),o(`div`,{key:F.value,class:`step-detail`},[c(`div`,w,[c(`h2`,null,d(I[F.value].title),1),c(`p`,null,d(I[F.value].subtitle),1)]),c(`div`,T,[g[4]||=c(`h3`,null,`目标状态`,-1),I[F.value].targetImage?(l(),o(`div`,E,[e(V,{src:I[F.value].targetImage,fit:`cover`},null,8,[`src`])])):(l(),o(`div`,D,[...g[3]||=[c(`span`,{class:`placeholder-icon`},`🎲`,-1),c(`span`,{class:`placeholder-text`},`目标状态示意图`,-1)]])),c(`p`,null,d(I[F.value].targetDesc),1)]),c(`div`,O,[c(`div`,{innerHTML:I[F.value].content},null,8,k)]),I[F.value].formula&&I[F.value].formula.length>0?(l(),o(`div`,A,[g[5]||=c(`h3`,null,`核心公式`,-1),(l(!0),o(s,null,u(I[F.value].formula,(e,t)=>(l(),o(`div`,{key:t,class:`formula-group`},[c(`div`,j,[(l(!0),o(s,null,u(e,(e,t)=>(l(),o(`span`,{key:t,class:`formula-item`},d(e),1))),128))])]))),128))])):i(``,!0),I[F.value].tips?(l(),o(`div`,M,[g[6]||=c(`h3`,null,`小贴士`,-1),c(`ul`,null,[(l(!0),o(s,null,u(I[F.value].tips,(e,t)=>(l(),o(`li`,{key:t},d(e),1))),128))])])):i(``,!0)]))]),_:1}),c(`div`,N,[e(v,{onClick:R,disabled:F.value===0,icon:`el-icon-arrow-left`},{default:f(()=>[...g[7]||=[_(` 上一步 `,-1)]]),_:1},8,[`disabled`]),F.value<I.length-1?(l(),r(v,{key:0,onClick:L,type:`primary`,icon:`el-icon-arrow-right`},{default:f(()=>[...g[8]||=[_(` 下一步 `,-1)]]),_:1})):(l(),r(v,{key:1,onClick:z,type:`success`,icon:`el-icon-check`},{default:f(()=>[...g[9]||=[_(` 完成学习 `,-1)]]),_:1}))])])])])}}},[[`__scopeId`,`data-v-9c6ddd18`]]);export{P as default};