import{Bt as e,C as t,Cn as n,Gt as r,Ht as i,K as a,Kt as o,Rt as s,Ut as c,Vt as l,hn as u,jt as d,m as f,on as p,p as m,rn as h,t as g,tn as _}from"./_plugin-vue_export-helper-CK62nBzC.js";import{M as v}from"./index-BjRl01ym.js";import"./css-BXC66Doa2.js";var y={class:`tutorial-container`},b={class:`tutorial-header`},x={class:`tutorial-body`},S={class:`steps-sidebar`},C={class:`steps-content`},w={class:`step-header`},T={class:`step-target`},E={key:0,class:`target-image`},D={key:1,class:`target-image placeholder`},O={class:`step-content`},k=[`innerHTML`],A={key:0,class:`step-formula`},j={class:`formula-box`},M={key:1,class:`step-tips`},N={class:`step-nav`},P=g({__name:`BeginnerTutorial`,setup(g){let P=v(),F=u(0),I=[{title:`第一步：对好第一面十字`,subtitle:`建立白色底面十字`,targetImage:`https://aka.doubaocdn.com/s/tmLs1wo1lu`,targetDesc:`目标：白色底面十字，四个侧面的棱与中心块同色`,content:`
    ...
    `,formula:[[`F2`,`U`,`L`,`R'`,`F2`,`L'`,`R`,`U`,`F2`]],tips:[`先找已经归位的棱块`,`归位的面放在后面`,`做完公式后检查魔方是否完全还原`,`如果还没还原，再做一次公式`]}],L=()=>{F.value<I.length-1&&F.value++},R=()=>{F.value>0&&F.value--},z=()=>{P.push(`/tutorials`)};return(u,g)=>{let v=a,P=m,B=f,V=t;return _(),c(`div`,y,[e(`div`,b,[g[1]||=e(`h1`,null,`三阶魔方入门教程`,-1),g[2]||=e(`p`,{class:`subtitle`},`层先法 - 7步还原魔方`,-1),o(v,{onClick:z,icon:`el-icon-arrow-left`,plain:``,size:`small`},{default:p(()=>[...g[0]||=[r(`返回首页`,-1)]]),_:1})]),e(`div`,x,[e(`div`,S,[o(B,{active:F.value,"align-center":``,direction:`vertical`},{default:p(()=>[(_(),c(s,null,h(I,(t,r)=>o(P,{key:r,title:t.title},{description:p(()=>[e(`span`,null,n(t.subtitle),1)]),_:2},1032,[`title`])),64))]),_:1},8,[`active`])]),e(`div`,C,[o(d,{name:`fade`,mode:`out-in`},{default:p(()=>[(_(),c(`div`,{key:F.value,class:`step-detail`},[e(`div`,w,[e(`h2`,null,n(I[F.value].title),1),e(`p`,null,n(I[F.value].subtitle),1)]),e(`div`,T,[g[4]||=e(`h3`,null,`目标状态`,-1),I[F.value].targetImage?(_(),c(`div`,E,[o(V,{src:I[F.value].targetImage,fit:`cover`},null,8,[`src`])])):(_(),c(`div`,D,[...g[3]||=[e(`span`,{class:`placeholder-icon`},`🎲`,-1),e(`span`,{class:`placeholder-text`},`目标状态示意图`,-1)]])),e(`p`,null,n(I[F.value].targetDesc),1)]),e(`div`,O,[e(`div`,{innerHTML:I[F.value].content},null,8,k)]),I[F.value].formula&&I[F.value].formula.length>0?(_(),c(`div`,A,[g[5]||=e(`h3`,null,`核心公式`,-1),(_(!0),c(s,null,h(I[F.value].formula,(t,r)=>(_(),c(`div`,{key:r,class:`formula-group`},[e(`div`,j,[(_(!0),c(s,null,h(t,(e,t)=>(_(),c(`span`,{key:t,class:`formula-item`},n(e),1))),128))])]))),128))])):i(``,!0),I[F.value].tips?(_(),c(`div`,M,[g[6]||=e(`h3`,null,`小贴士`,-1),e(`ul`,null,[(_(!0),c(s,null,h(I[F.value].tips,(e,t)=>(_(),c(`li`,{key:t},n(e),1))),128))])])):i(``,!0)]))]),_:1}),e(`div`,N,[o(v,{onClick:R,disabled:F.value===0,icon:`el-icon-arrow-left`},{default:p(()=>[...g[7]||=[r(` 上一步 `,-1)]]),_:1},8,[`disabled`]),F.value<I.length-1?(_(),l(v,{key:0,onClick:L,type:`primary`,icon:`el-icon-arrow-right`},{default:p(()=>[...g[8]||=[r(` 下一步 `,-1)]]),_:1})):(_(),l(v,{key:1,onClick:z,type:`success`,icon:`el-icon-check`},{default:p(()=>[...g[9]||=[r(` 完成学习 `,-1)]]),_:1}))])])])])}}},[[`__scopeId`,`data-v-1428dff6`]]);export{P as default};