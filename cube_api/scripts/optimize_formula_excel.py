...
DIFFICULTY_MAP = {"F2L": 3, "OLL": 3, "PLL": 4}
...
TAG_MAP = {"F2L": "F2L,基础", "OLL": "OLL,常用", "PLL": "PLL,进阶"}
...
def optimize_excel():
    ...
    for phase in ["F2L", "OLL", "PLL"]:
        ...
        for row_idx in range(2, ws.max_row + 1):
            ...
            new_row = [seq, formula_name, notation, 3, "CFOP", phase, difficulty, description, new_image_name, tags]
