...
class SmartCubeDeviceViewSet(viewsets.ModelViewSet):
    ...
    def destroy(self, request, *args, **kwargs):
        ...
        if instance.user != request.user:
            return APIResponse(code=403, msg="无权删除该设备", status=status.HTTP_403_FORBIDDEN)
...
class TimerRecordViewSet(viewsets.ModelViewSet):
    ...
    def stats(self, request):
        ...
        stats = (
            valid_queryset.values("cube_type", "method", "timing_mode")
            .annotate(total_count=Count("id"), best_time=Min("time_ms"), avg_time=Avg("time_ms"))
        ...
        overall_stats = {
            ...
            "avg_time": (
                round(valid_queryset.aggregate(Avg("time_ms"))["time_ms__avg"], 2) if valid_queryset.exists() else 0
            ),
        }
    ...
    def trend(self, request):
        ...
        date_stats = (
            ...
            .annotate(times=Min("time_ms"), avg_time=Avg("time_ms"))
