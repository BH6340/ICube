...
from apps.forum.models import Comment, Post, Tag
...
class ForumBaseTestCase(TestCase):
    ...
    def create_test_post(self, author=None, title=None, content=None, **kwargs):
        ...
        post = Post.objects.create(title=title, content=content, author=author, **kwargs)
        return post
    ...
    def get_invalid_post_data(self):
        """获取无效的帖子数据（用于测试验证）"""
        return {"title": "短", "content": "短", "tag_ids": []}
