...
from apps.shop.models import Address, Cart, Order, OrderItem, Product, ProductCategory
...
class ProductCategoryModelTest(TestCase):
    ...
    def setUp(self):
        self.category = ProductCategory.objects.create(name="测试分类", description="测试描述")
    ...
    def test_sub_category(self):
        """测试子分类"""
        sub = ProductCategory.objects.create(name="子分类", parent=self.category)
    ...
    def test_category_ordering(self):
        ...
        categories = ProductCategory.objects.filter(id__in=[cat_a.id, cat_b.id]).order_by("sort_order")
...
class ProductModelTest(TestCase):
    ...
    def setUp(self):
        ...
        self.product = Product.objects.create(
            name="测试商品", price=Decimal("99.99"), stock=100, category=self.category
        )
...
class CartModelTest(TestCase):
    ...
    def setUp(self):
        self.user = User.objects.create_user(email="cart@example.com", password="testpass", username="cartuser")
        self.product = Product.objects.create(name="购物车商品", price=Decimal("50.00"), stock=10)
...
class OrderModelTest(TestCase):
    ...
    def setUp(self):
        self.user = User.objects.create_user(email="order@example.com", password="testpass", username="orderuser")
...
class OrderItemModelTest(TestCase):
    ...
    def setUp(self):
        self.user = User.objects.create_user(
            email="orderitem@example.com", password="testpass", username="orderitemuser"
        )
        self.product = Product.objects.create(name="订单商品", price=Decimal("25.00"), stock=100)
    ...
    def test_create_order_item_success(self):
        """测试创建订单明细"""
        item = OrderItem.objects.create(order=self.order, product=self.product, price=Decimal("25.00"), quantity=2)
    ...
    def test_order_item_str_method(self):
        """测试 __str__ 方法"""
        item = OrderItem.objects.create(order=self.order, product=self.product, price=Decimal("25.00"), quantity=1)
...
class AddressModelTest(TestCase):
    ...
    def setUp(self):
        self.user = User.objects.create_user(email="address@example.com", password="testpass", username="addressuser")
