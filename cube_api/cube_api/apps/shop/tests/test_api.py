...
from apps.shop.models import Cart, Order, ProductCategory
from django.contrib.auth import get_user_model
from rest_framework import status

from .base import ShopAPITestCase, ShopBaseTestCase
...
class AddressAPITest(ShopAPITestCase):
    ...
    def test_set_default_address(self):
        ...
        self.create_test_address(name="李四", is_default=False)
