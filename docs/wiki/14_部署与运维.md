...
| `/docs/`   | `alias /usr/share/nginx/html/docs/;`，Docsify 文档站点，`index index.html` + `try_files` SPA 回退；`default_type text/plain` + `Content-Disposition: inline`，`.md` 等无 MIME 映射文件在浏览器内联显示 |
