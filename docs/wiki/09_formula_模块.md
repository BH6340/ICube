...
### 9.2 数据模型（[models.py](/code/cube_api/cube_api/apps/formula/models.py)）
...
#### Formula 字段（[L124-L233](/code/cube_api/cube_api/apps/formula/models.py#L124-L233)）
...
### 9.3 URL 路由表（[urls.py](/code/cube_api/cube_api/apps/formula/urls.py)）
...
### 9.4 视图说明（[views.py](/code/cube_api/cube_api/apps/formula/views.py)）

#### FormulaViewSet（[L289-L589](/code/cube_api/cube_api/apps/formula/views.py#L289-L589)）
...
### 9.5 序列化器（[serializers.py](/code/cube_api/cube_api/apps/formula/serializers.py)）

#### FormulaSerializer（详情，[L252-L599](/code/cube_api/cube_api/apps/formula/serializers.py#L252-L599)）
...
**create（[L377-L485](/code/cube_api/cube_api/apps/formula/serializers.py#L377-L485)）**：
...
**update（[L487-L599](/code/cube_api/cube_api/apps/formula/serializers.py#L487-L599)）**：
...
### 9.6 服务层（[services.py](/code/cube_api/cube_api/apps/formula/services.py)）

#### FormulaService（[L17-L87](/code/cube_api/cube_api/apps/formula/services.py#L17-L87)）
...
#### FormulaMatchService（[L439-L563](/code/cube_api/cube_api/apps/formula/services.py#L439-L563)）

- `match_formulas(user_state)`：前置状态匹配 + 目标状态匹配
- `_is_state_match`：公式状态中 `-` 跳过，部分匹配
- ⚠️ `_execute_formula` 为占位（转动模拟未实现，退化为原状态比较）

### 9.7 过滤器（[filters.py](/code/cube_api/cube_api/apps/formula/filters.py)）
...
### 9.8 权限类（[permissions.py](/code/cube_api/cube_api/apps/formula/permissions.py)）
