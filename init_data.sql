...
CREATE TABLE `formula_cube_category`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `formula_cube_category_order_method_phase_203c2a59_uniq`(`order` ASC, `method` ASC, `phase` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 7 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of formula_cube_category
-- ----------------------------
INSERT INTO `formula_cube_category` VALUES (4, 3, 'CFOP', 'F2L', '三阶魔方 CFOP 法 F2L', '三阶魔方 CFOP 方法的 F2L 阶段', 1, '2026-07-07 11:06:37.916198');
INSERT INTO `formula_cube_category` VALUES (5, 3, 'CFOP', 'OLL', '三阶魔方 CFOP 法 OLL', '三阶魔方 CFOP 方法的 OLL 阶段', 2, '2026-07-07 11:06:38.954387');
INSERT INTO `formula_cube_category` VALUES (6, 3, 'CFOP', 'PLL', '三阶魔方 CFOP 法 PLL', '三阶魔方 CFOP 方法的 PLL 阶段', 3, '2026-07-07 11:06:40.360197');
